...
import { setCategoryProducts } from '../../action/client/category';
...
const categoryProduct=useSelector(state=>state.category.categoryProducts)
  ...
  useEffect(()=>{
    const FindPro = ()=>{
      ...
      if(ProductId && ProductId.productIds){
        ...
        dispatch(setCategoryProducts(ProductOfCat))}
      else {
